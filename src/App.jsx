...
function App() {
  ...
  const mutation = useMutation({
    ...
    onSuccess: (data) => setChat((prev) =>
     [...prev, { sender:'ai', message: data.message.replace(/^\n\n/, "")}])
  })
  ...
  return (
    ...
    relative sm:px-16 px-12 text-white overflow-hidden 
...
<div className='gradient-02 z-0 absolute'></div>
      ...
      scrollbar-track-gray-transparent scrollbar-thumb-rounded-md '>
        <Chatbody chat={chat}/>  
      </div>
